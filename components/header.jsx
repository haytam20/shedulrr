...
async function Header() {
  ...
  <Button 
    variant="default" 
    className="bg-gray-900 hover:bg-white text-white hover:text-black px-4 py-2 rounded-none text-sm font-medium flex items-center gap-2 border border-white"
  >
    <PenBox size={16} />
...
<SignedOut>
  <SignInButton forceRedirectUrl="/dashboard">
    <Button 
      variant="outline"
      className="border border-orange-500 bg-transparent text-orange-500 rounded-none hover:bg-orange-600 hover:text-white text-sm font-medium"
    >
      Login
    </Button>
  </SignInButton>
